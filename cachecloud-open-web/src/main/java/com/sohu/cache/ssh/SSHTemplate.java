...
public class SSHTemplate {
	...
	private static ThreadPoolExecutor taskPool = new ThreadPoolExecutor(
			20, 200, 30L, TimeUnit.MILLISECONDS, new LinkedBlockingQueue<Runnable>(1000),
	...
	public Result execute(String ip, SSHCallback callback) throws SSHException{
		...
		return execute(ip,ConstUtils.DEFAULT_SSH_PORT_DEFAULT, thisMachine.getSshUser(),
				thisMachine.getSshPasswd(), callback);

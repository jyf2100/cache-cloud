...
public class PortGeneratorTest extends BaseTest {
    ...
    public void testCheckMaxPort() throws SSHException {
        ...
        for (MachineInfo machineInfo : machineList) {
            ...
            String m1 = PortGenerator.getMaxPortStrOld(ip, sshPort,thisMachine.getSshUser(),thisMachine.getSshPasswd());
            String m2 = PortGenerator.getMaxPortStr(ip, sshPort,thisMachine.getSshUser(),thisMachine.getSshPasswd());

...
//    public static int COUNT_DIFF = DEFAULT_COUNT;
//
//
//    public static String DEFAULT_USERNAME_DIFF = "cachecloud";
//    public static String USERNAME_DIFF[];
//
//    public static String DEFAULT_PASSWORD_DIFF = "cachecloud";
//    public static String PASSWORD_DIFF[];
//
//    public static int DEFAULT_SSH_PORT_DEFAULT_DIFF = 22;
//    public static int SSH_PORT_DEFAULT_DIFF[];
